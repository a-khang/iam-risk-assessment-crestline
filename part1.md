...
- Secure access should be seamless for internal users. Complexity incentivizes workarounds, which will undermine any IAM strategy Insightra implements.

## Identity Governance & Developing Access Policies
